...
public class SimplexProblemSolver {
    ...
    public SimplexProblemSolution solveSimplexProblem(SimplexProblem simplexProblem) {
        ...
        SimplexProblemSolution solution = solveCanonicSimplexProblem(canonicSimplexProblem);
        System.out.println(Utils.getEnvelope("Розв'язок задачі лінійного програмування", solution.toString()));
        return solution;
    }

    private SimplexProblemSolution solveCanonicSimplexProblem(CanonicSimplexProblem canonicSimplexProblem) {
